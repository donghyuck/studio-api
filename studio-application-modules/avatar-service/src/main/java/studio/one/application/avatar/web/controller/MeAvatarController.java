package studio.one.application.avatar.web.controller;
...
import studio.one.application.avatar.web.dto.response.AvatarImageDto;
import studio.one.application.avatar.web.dto.request.AvatarImageMetaUpdateRequest;
import studio.one.application.avatar.web.dto.response.AvatarPresenceDto;
