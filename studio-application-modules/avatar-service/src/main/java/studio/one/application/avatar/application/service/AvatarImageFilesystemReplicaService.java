...
import static studio.one.application.avatar.infrastructure.replica.FileReplicaStore.sha256Hex;
...
import studio.one.application.avatar.infrastructure.replica.FileReplicaStore; // ← 패키지 확인
import studio.one.application.avatar.application.usecase.AvatarImageService;
import studio.one.application.avatar.application.usecase.AvatarImageService.ThumbnailOptions;
