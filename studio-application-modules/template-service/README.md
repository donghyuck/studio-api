...
4. (선택) 기본 base-path가 필요에 맞게 `/api/mgmt/templates` 이외로 조정하고, DDL(`schema/template/{db}/V900__create_template_tables.sql`)을 적용한다. Flyway 버전 범위는 `docs/flyway-versioning.md`의 template 범위(V900-V999)를 따른다.
