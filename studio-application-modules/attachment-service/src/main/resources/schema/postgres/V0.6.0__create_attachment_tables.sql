...
CREATE TABLE TB_APPLICATION_ATTACHMENT_DATA (
    ATTACHMENT_ID INTEGER NOT NULL, -- 첨부파일 ID
...
CREATE INDEX IDX_TB_APPLICATION_ATTACHMENT_OBJECT ON AC_UI_ATTACHMENT (OBJECT_TYPE, OBJECT_ID);
CREATE INDEX IDX_TB_APPLICATION_ATTACHMENT_USER ON AC_UI_ATTACHMENT (USER_ID);   