package studio.one.platform.objecttype.infrastructure.persistence.jdbc;

import java.util.Optional;

import studio.one.platform.objecttype.infrastructure.persistence.jdbc.model.JdbcObjectTypeMetadata;
