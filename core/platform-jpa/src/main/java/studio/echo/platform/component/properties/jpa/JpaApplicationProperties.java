 ...
 *
 */
package studio.echo.platform.component.properties.jpa;
...
import studio.echo.platform.component.properties.jpa.entity.Property;
...
public class JpaApplicationProperties implements ApplicationProperties {
    ...
    protected void initialize() {
        log.info(LogUtil.format(i18n, MessageCodes.Info.COMPONENT_STATE, LogUtil.blue(getClass(), true),
                LogUtil.red(State.INITIALIZING.toString())));
        ...
        log.info(LogUtil.format(i18n, MessageCodes.Info.COMPONENT_STATE, LogUtil.blue(getClass(), true),
                LogUtil.red(State.INITIALIZED.toString())));
    }
