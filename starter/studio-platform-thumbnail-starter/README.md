...
- `studio.attachment.thumbnail.default-size/default-format`와 `studio.features.attachment.thumbnail.default-size/default-format`는 deprecated fallback으로만 읽고 WARN을 출력한다.
