...
import studio.one.platform.objecttype.infrastructure.yaml.YamlObjectPolicyResolver;
import studio.one.platform.objecttype.infrastructure.yaml.YamlObjectRebindService;
import studio.one.platform.objecttype.infrastructure.yaml.YamlObjectTypeRegistry;
import studio.one.platform.autoconfigure.PersistenceProperties;
import studio.one.platform.autoconfigure.objecttype.condition.ConditionalOnObjectTypePersistence;
import studio.one.platform.autoconfigure.I18nKeys;
import studio.one.platform.objecttype.infrastructure.persistence.jdbc.JdbcObjectPolicyResolver;
import studio.one.platform.objecttype.infrastructure.persistence.jdbc.JdbcObjectTypeRegistry;
...
import studio.one.platform.objecttype.infrastructure.persistence.jpa.JpaObjectTypeStore;
import studio.one.platform.objecttype.infrastructure.persistence.jpa.entity.ObjectTypeEntity;
import studio.one.platform.objecttype.infrastructure.persistence.jpa.repo.ObjectTypeJpaRepository;
import studio.one.platform.objecttype.infrastructure.persistence.jpa.repo.ObjectTypePolicyJpaRepository;
import studio.one.platform.objecttype.infrastructure.persistence.jpa.service.JpaObjectPolicyResolver;
import studio.one.platform.objecttype.infrastructure.persistence.jpa.service.JpaObjectTypeRegistry;
import studio.one.platform.objecttype.infrastructure.persistence.mybatis.MyBatisObjectPolicyResolver;
import studio.one.platform.objecttype.infrastructure.persistence.mybatis.MyBatisObjectTypeRegistry;
...
import studio.one.platform.objecttype.infrastructure.cache.CachedObjectPolicyResolver;
import studio.one.platform.objecttype.infrastructure.cache.CachedObjectTypeRegistry;
import studio.one.platform.objecttype.infrastructure.cache.CachedObjectRebindService;
import studio.one.platform.objecttype.infrastructure.cache.CacheInvalidatable;
