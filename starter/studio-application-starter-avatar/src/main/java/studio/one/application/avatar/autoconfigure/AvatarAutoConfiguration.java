...
import studio.one.application.avatar.infrastructure.persistence.jpa.AvatarImageDataJpaRepository;
import studio.one.application.avatar.infrastructure.persistence.jpa.AvatarImageJpaRepository;
import studio.one.application.avatar.infrastructure.replica.FileReplicaStore;
import studio.one.application.avatar.application.usecase.AvatarImageService;
import studio.one.application.avatar.application.service.AvatarImageFilesystemReplicaService;
import studio.one.application.avatar.application.service.AvatarImageServiceImpl;
