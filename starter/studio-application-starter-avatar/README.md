...
- 스키마 마이그레이션 파일은 `avatar-service/src/main/resources/schema/avatar/{db}/V700__create_avatar_tables.sql` 에 위치한다. Flyway 버전 범위는 `docs/flyway-versioning.md`의 avatar 범위(V700-V799)를 따른다.
