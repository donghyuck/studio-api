...
public record SearchRequest(
    ...
    public SearchRequest(String query, Integer topK, String objectType, String objectId,
            String embeddingProfileId, String embeddingProvider, String embeddingModel, Double minScore) {
        this(query, topK, objectType, objectId, embeddingProfileId, embeddingProvider, embeddingModel,
                minScore, null);
    }

    public SearchRequest(String query, int topK) {
        this(query, topK, null, null, null, null, null, null, null);
    }

    public SearchRequest(String query, int topK, String objectType, String objectId) {
        this(query, topK, objectType, objectId, null, null, null, null, null);
    }
}
