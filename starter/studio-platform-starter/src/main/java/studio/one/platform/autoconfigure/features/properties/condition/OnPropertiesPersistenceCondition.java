package studio.one.platform.autoconfigure.features.properties.condition;
...
class OnPropertiesPersistenceCondition extends SpringBootCondition {

    @Override
    public ConditionOutcome getMatchOutcome(ConditionContext context, AnnotatedTypeMetadata metadata) {
        Map<String, Object> attributes = metadata.getAnnotationAttributes(ConditionalOnPropertiesPersistence.class.getName());
    ...
    private Type resolveUserPersistence(ConditionContext context) {
        ...
        Type feature = parseType(env.getProperty(PropertyKeys.Features.ApplicationProperties.PREFIX + ".persistence"), null);
