...
public class UserFeatureProperties extends FeatureToggle {
    ...
    public static final String DEFAULT_REPOSITORY_PACKAGE = "studio.echo.base.user.domain.repository";

    public static final String DEFAULT_ENTITY_PACKAGE = "studio.echo.base.user.domain.entity";

    public static final String DEFAULT_COMPONENT_PACKAGE = "studio.echo.base.user.service.impl";
