...
/**
 * @deprecated Use {@link studio.one.platform.security.authz.acl.AclPermissionService} instead.
 */
...
public class AclPermissionService extends DefaultAclPermissionService {
    ...
    public static Sid roleSid(String role) {
        return studio.one.platform.security.authz.acl.AclPermissionService.roleSid(role);
    }

    public static Sid userSid(String username) {
        return studio.one.platform.security.authz.acl.AclPermissionService.userSid(username);
    }
}
