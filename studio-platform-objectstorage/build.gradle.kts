...
dependencies {
    ...
    implementation("com.oracle.oci.sdk:oci-java-sdk:$oracleOciSdkVersion")
    implementation("com.oracle.oci.sdk:oci-java-sdk-objectstorage:$oracleOciSdkVersion")
    implementation("com.oracle.oci.sdk:oci-java-sdk-common-httpclient-jersey:$oracleOciSdkVersion")    
}