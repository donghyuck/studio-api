...
CREATE INDEX idx_skill_source_chunk_source
...
CREATE INDEX idx_skill_dictionary_status
...
CREATE INDEX idx_skill_candidate_status
    ON tb_skill_candidate(status, created_at);

CREATE INDEX idx_skill_candidate_normalized
...
CREATE INDEX idx_skill_ncs_mapping_unit
...
CREATE INDEX idx_skill_course_mapping_course
    ON tb_skill_course_mapping(course_id);

CREATE INDEX idx_skill_course_mapping_skill
