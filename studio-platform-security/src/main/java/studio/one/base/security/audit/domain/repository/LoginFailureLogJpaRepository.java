...
@Repository
public interface LoginFailureLogJpaRepository extends JpaRepository<LoginFailureLog, Long>,
        JpaSpecificationExecutor<LoginFailureLog>, LoginFailureLogRepository {
