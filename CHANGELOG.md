...
### 변경됨
- 이슈 #415 대응으로 `studio-application-modules:wiki-service`와 `starter:studio-application-starter-wiki`를 추가해 workspace 단위 Wiki page/revision MVP, 사용자용/관리용 API, markdown render/sanitize, JPA schema `V1400`을 제공한다.
