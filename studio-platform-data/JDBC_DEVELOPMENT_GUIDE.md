...
권장 구조(도메인 기준):
```
studio-platform-objecttype/src/main/resources/schema/objecttype/postgres/V200__create_objecttype_tables.sql
studio-platform-objecttype/src/main/resources/schema/objecttype/mysql/V200__create_objecttype_tables.sql
```
