...
public class CompanyJoinRequestDto {
    ...
    public CompanyJoinRequestDto(Long requestId, Long companyId, Long keyId, Long userId, String name, String email, String message, CompanyRole requestedRole, CompanyJoinRequestStatus status, Instant requestedAt, Long requestedBy, Instant decidedAt, Long decidedBy) {
