...
public class CompanyMemberDto {
    ...
    public CompanyMemberDto(Long companyId, Long userId, CompanyRole role, CompanyMemberStatus status, Instant joinedAt, Long joinedBy, Instant updatedAt, Long updatedBy) {
