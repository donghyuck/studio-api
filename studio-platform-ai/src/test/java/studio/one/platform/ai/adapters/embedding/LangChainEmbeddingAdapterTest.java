...
class LangChainEmbeddingAdapterTest {
    ...
    void shouldConvertLangChainEmbedding() {
        ...
        when(model.embedAll(List.of("hello", "world")))
                .thenReturn(List.of(Embedding.from(new float[]{1.0f, 2.0f}), Embedding.from(new float[]{3.0f, 4.0f})));
        ...
        verify(model).embedAll(List.of("hello", "world"));
    }
}
